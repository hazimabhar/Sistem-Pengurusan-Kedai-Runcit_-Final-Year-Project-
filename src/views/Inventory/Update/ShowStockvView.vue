  ...
  <div>
    ...
    <div>
        ...
        <div class="w-full grid grid-cols-8 gap-2 mx-auto text-center text-sm max-lg:grid-cols-4 max-md:grid-cols-2">
          <RouterLink to="/manageinventory/update/can" class="bg-teal-500 text-white rounded-lg py-2 hover:text-black text-xs focus:text-black"><i class="fa-solid fa-drum-steelpan text-sm max-lg:hidden"></i><br class="max-lg:hidden"> Tin</RouterLink>
          <RouterLink to="/manageinventory/update/detergent" class="bg-teal-500 text-white rounded-lg py-2 text-xs hover:text-black focus:text-black "><i class="fa-solid fa-jug-detergent text-sm max-lg:hidden"></i><br class="max-lg:hidden"> Sabun</RouterLink>
