...
<template>
  <div>
    ...
    <div>
        ...
        <div class="w-full mt-5 grid grid-cols-8 gap-2 mx-auto text-center text-sm max-lg:grid-cols-4 max-md:grid-cols-2">
          ...
          <RouterLink to="/manageinventory/delete/sauce" class="bg-teal-500 text-white rounded-lg py-2 text-xs hover:text-black focus:text-black"><i class="fa-solid fa-wine-bottle text-sm max-lg:hidden"></i><br class="max-lg:hidden">Sos & Kicap</RouterLink>
  ...
  <div id="overlay" class="fixed z-40 w-screen h-screen inset-0 bg-gray-900 bg-opacity-50" v-bind:class="{'hidden': !isOpen}"></div>
    <dialog class="w-[30%] mx-auto shadow-product rounded-2xl absolute top-44 z-50 max-lg:w-[75%]" v-bind:open="isOpen">
