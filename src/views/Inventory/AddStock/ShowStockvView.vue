    ...
    <div>
        ...
        <form class="flex max-sm:block" @submit.prevent="searchItem" autocomplete="off" >
                    <div class="relative  mt-[2px]" >
                        <input ref="barkodProduk" v-model="barkodProduk" class=" bg-white py-1 px-5 pr-80 rounded-3xl outline outline-1 outline-emerald-700 shadow-input max-lg:pr-48 max-sm:pr-[40px]" placeholder="Imbas Kodbar"  type="text"  id="kodbar">
        ...
        <div class="w-full mt-5 grid grid-cols-8 gap-2 mx-auto text-center text-sm max-lg:grid-cols-4 max-md:grid-cols-2">
          ...
          <RouterLink to="/manageinventory/add/sauce" class="bg-teal-500 text-white rounded-lg py-2 text-xs hover:text-black focus:text-black"><i class="fa-solid fa-wine-bottle text-sm max-lg:hidden"></i><br class="max-lg:hidden">Sos & Kicap</RouterLink>
