                ...
                <div class="w-full px-10 max-sm:p-0">
                    ...
                    <form class="" @submit.prevent="registerProduct()">
                        ...
                        <div class="w-max mx-auto flex gap-10 mt-1 max-sm:gap-5">
                            <div class="mt-[31px]">
                                <RouterLink  to="/manager/managermanageinventory" class="w-max bg-red-600 text-white rounded-3xl py-2 px-20 mt-6 hover:outline hover:outline-black  hover:bg-white hover:text-black" >Batal</RouterLink>
                            </div>
                            <div class="mt-[14px]">
    ...
    <dialog class="w-1/4 mx-auto shadow-product rounded-2xl  fixed top-44 z-50" v-bind:open="completeRegister">
        <div class="">
            ...
            <div class="flex justify-evenly">
                <div class="mt-[7px]">
                    <RouterLink  to="/manager/managershowstock" class="w-max bg-blue-600 text-white p-2 px-5 rounded-xl hover:bg-white hover:text-black hover:outline hover:outline-black text-sm " >Senarai Produk</RouterLink>
                </div>
                <div>
