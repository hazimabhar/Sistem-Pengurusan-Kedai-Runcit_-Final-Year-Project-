  ...
  <div>
    ...
    <div>
        ...
        <div class="w-full mt-5 grid grid-cols-8 gap-2 mx-auto text-center text-sm max-lg:grid-cols-4 max-md:grid-cols-2">
          ...
          <RouterLink to="/manager/managermanageinventory/update/sauce" class="bg-teal-500 text-white rounded-lg py-2 text-xs hover:text-black focus:text-black"><i class="fa-solid fa-wine-bottle text-sm max-lg:hidden"></i><br class="max-lg:hidden">Sos & Kicap</RouterLink>
    ...
    <dialog class="w-[30%] mx-auto shadow-product rounded-2xl  absolute top-44 z-50" v-bind:open="isOpen">
        <div class=""  v-if="selectedItem">
            ...
            <div class="flex justify-evenly">
                ...
                <div class="mt-[7px]">
                    <RouterLink  v-bind:to="`/manager/updateproduct/`+updateId" class="w-max bg-blue-600 text-white p-2 px-5 rounded-xl hover:bg-white hover:text-black hover:outline hover:outline-black " >Kemaskini</RouterLink>
                </div>
            </div>
        </div>
    </dialog>
