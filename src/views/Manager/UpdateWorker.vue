    ...
    methods:
    {
        ...
        { 
            this.loading = true
                ...
                await axios.get("https://sistemkedairuncit.onrender.com/worker/"+this.userId)
                .then(response=>{
        ...
        async submitForm()
        {
                ...
                if(this.user.name && this.user.phoneNumber && this.user.email && this.user.address && this.user.gender)
            {
                ...
                if(!this.errorEmail)
                {
                    await axios.put("https://sistemkedairuncit.onrender.com/worker/"+this.userId, this.user)
                    .then(response=>console.log(response))
                    const message ='Maklumat Pekerja Berjaya Dikemaskini'
