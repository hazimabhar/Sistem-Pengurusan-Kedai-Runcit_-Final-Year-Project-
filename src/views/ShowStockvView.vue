          ...
          <div class="flex ml-14 ">
              <form class="flex max-sm:block" @submit.prevent="searchItem" autocomplete="off" >
                    <div class="relative max-sm:right-[28px] mt-[2px]" >
                        <input ref="barkodProduk" v-model="barkodProduk" class=" bg-white py-1 px-5 pr-80 rounded-3xl outline outline-1 outline-emerald-700 shadow-input max-lg:pr-40 max-sm:pr-[25px] " placeholder="Imbas Kodbar"  type="text"  id="kodbar">
