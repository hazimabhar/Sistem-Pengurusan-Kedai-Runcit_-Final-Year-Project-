    ...
    <div class="fixed py-3 w-full bg-teal-500 select-none z-10" >
        <div class="max-sm:w-full" >
            <div class="flex pl-5">
                ...
                <div class="text-lg pt-2 ml-[650px] mr-[535px] max-sm:mx-[30px]  max-lg:ml-[245px] max-lg:mr-[200px]">
                    <RouterLink class="font-semibold" to="/home">Sistem Kedai Runcit</RouterLink>
                </div>
                <div class="flex">
                    <i class="fa-solid fa-user mt-3"></i>
                    <p class="font-semibold mt-2 ml-2 max-sm:hidden">Pekerja</p>
                </div>
            </div>
